...
\begin{flalign}
  ...
  &\quad isNothing \enspace (blandRatioPrimal \enspace f) \label{br-undef-null} \tag{BR-UNDEF-NULL}
\end{flalign}
...
\begin{flalign}
  ...
  &\quad isNothing \enspace (blandRatioPrimal \enspace f) \label{br-neg-null} \tag{BR-NEG-NULL}
\end{flalign}
